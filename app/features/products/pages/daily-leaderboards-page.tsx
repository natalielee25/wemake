...
export const meta: Route.MetaFunction = ({ params }) => {
  ...
  return [
    {
      title: `The best of ${month} ${day}, ${year} | wemake`,
    },
  ];
};
