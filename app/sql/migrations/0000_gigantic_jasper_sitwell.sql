...
CREATE TYPE "public"."location" AS ENUM('on-site', 'remote', 'hybrid');--> statement-breakpoint
CREATE TYPE "public"."salary_range" AS ENUM('$0 - $ 50,000', '$50,000 - $75,000', '$75,000 - $100,000', '$100,000 - $125,000', '$125,000 - $150,000', '$150,000 - $200,000', '$200,000+');--> statement-breakpoint
CREATE TABLE "jobs" (
